...
export class MenuitemController {
  ...
  @Post(`/api/${USERS_ROUTES.ADMIN}/menuitems`)
  ...
  @Patch(`/api/${USERS_ROUTES.ADMIN}/menuitems/:menuitemId`)
  ...
  @Get(`/api/${USERS_ROUTES.ADMIN}/menuitems`)
  ...
  @Get(`/api/${USERS_ROUTES.ADMIN}/menuitems/:menuitemId`)
